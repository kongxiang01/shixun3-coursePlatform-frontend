<template>
  <div class="container">
    <el-table :data="tableData">
      <el-table-column prop="hTitle" label="实验标题" align="center">
        <template #default="scope">
          <el-link type="primary" :underline="false" @click="handleHW">{{scope.row.hTitle}}</el-link>
        </template>
      </el-table-column>
      <el-table-column prop="hStart" label="实验开始" align="center"></el-table-column>
      <el-table-column prop="hEnd" label="实验截止" align="center"></el-table-column>
    ...
    <el-drawer
        ...
        size="40%"
    >
      <div style="margin: 20px 0">报告内容</div>
      <el-form ref="form" :model="formData" class="form">
        <el-form-item>
          <el-input
              type="textarea"
              :rows="6"
              placeholder="请输入3000字以内的报告内容！"
